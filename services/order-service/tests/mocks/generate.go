...
//go:generate go run go.uber.org/mock/mockgen@latest -source=../../internal/domain/ports/publisher/order_created_publisher.go -destination=mock_publisher.go -package=mocks
