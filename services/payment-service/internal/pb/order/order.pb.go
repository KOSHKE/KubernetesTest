...
const file_order_order_proto_rawDesc = "" +
	"\n" +
	"\x11order/order.proto\x12\x05order\"\x90\x02\n" +
	"\x05Order\x12\x0e\n" +
	...
	"\x05total\x18\x06 \x01(\x01R\x05total\"\x87\x01\n" +
...
var file_order_order_proto_depIdxs = []int32{
	...
	1,  // 5: order.GetUserOrdersResponse.orders:type_name -> order.Order
	...
	1,  // 8: order.CancelOrderResponse.order:type_name -> order.Order
	3,  // 9: order.OrderService.CreateOrder:input_type -> order.CreateOrderRequest
	6,  // 10: order.OrderService.GetOrder:input_type -> order.GetOrderRequest
	8,  // 11: order.OrderService.GetUserOrders:input_type -> order.GetUserOrdersRequest
	10, // 12: order.OrderService.UpdateOrderStatus:input_type -> order.UpdateOrderStatusRequest
	...
	7,  // 15: order.OrderService.GetOrder:output_type -> order.GetOrderResponse
	9,  // 16: order.OrderService.GetUserOrders:output_type -> order.GetUserOrdersResponse
	11, // 17: order.OrderService.UpdateOrderStatus:output_type -> order.UpdateOrderStatusResponse
	13, // 18: order.OrderService.CancelOrder:output_type -> order.CancelOrderResponse
