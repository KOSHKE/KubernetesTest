...
var file_inventory_inventory_proto_depIdxs = []int32{
	...
	1,  // 2: inventory.GetProductResponse.product:type_name -> inventory.Product
	9,  // 3: inventory.CheckStockRequest.items:type_name -> inventory.StockCheckItem
	11, // 4: inventory.CheckStockResponse.results:type_name -> inventory.StockCheckResult
	13, // 5: inventory.ReserveStockRequest.items:type_name -> inventory.StockReservationItem
	13, // 6: inventory.ReleaseStockRequest.items:type_name -> inventory.StockReservationItem
	2,  // 7: inventory.GetCategoriesResponse.categories:type_name -> inventory.Category
	4,  // 8: inventory.InventoryService.GetProducts:input_type -> inventory.GetProductsRequest
	6,  // 9: inventory.InventoryService.GetProduct:input_type -> inventory.GetProductRequest
	8,  // 10: inventory.InventoryService.CheckStock:input_type -> inventory.CheckStockRequest
	12, // 11: inventory.InventoryService.ReserveStock:input_type -> inventory.ReserveStockRequest
	15, // 12: inventory.InventoryService.ReleaseStock:input_type -> inventory.ReleaseStockRequest
	17, // 13: inventory.InventoryService.GetCategories:input_type -> inventory.GetCategoriesRequest
	5,  // 14: inventory.InventoryService.GetProducts:output_type -> inventory.GetProductsResponse
	7,  // 15: inventory.InventoryService.GetProduct:output_type -> inventory.GetProductResponse
	10, // 16: inventory.InventoryService.CheckStock:output_type -> inventory.CheckStockResponse
	14, // 17: inventory.InventoryService.ReserveStock:output_type -> inventory.ReserveStockResponse
	16, // 18: inventory.InventoryService.ReleaseStock:output_type -> inventory.ReleaseStockResponse
	18, // 19: inventory.InventoryService.GetCategories:output_type -> inventory.GetCategoriesResponse
