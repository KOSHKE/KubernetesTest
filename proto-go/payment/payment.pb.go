...
const file_payment_payment_proto_rawDesc = "" +
	...
	"\bcurrency\x18\x02 \x01(\tR\bcurrency\"\xba\x02\n" +
	"\aPayment\x12\x0e\n" +
...
var file_payment_payment_proto_depIdxs = []int32{
	...
	2,  // 3: payment.ProcessPaymentRequest.amount:type_name -> payment.Money
	1,  // 4: payment.ProcessPaymentRequest.method:type_name -> payment.PaymentMethod
	5,  // 5: payment.ProcessPaymentRequest.details:type_name -> payment.PaymentDetails
	3,  // 6: payment.ProcessPaymentResponse.payment:type_name -> payment.Payment
	3,  // 7: payment.GetPaymentResponse.payment:type_name -> payment.Payment
	2,  // 8: payment.RefundPaymentRequest.amount:type_name -> payment.Money
	3,  // 9: payment.RefundPaymentResponse.payment:type_name -> payment.Payment
	4,  // 10: payment.PaymentService.ProcessPayment:input_type -> payment.ProcessPaymentRequest
	7,  // 11: payment.PaymentService.GetPayment:input_type -> payment.GetPaymentRequest
	9,  // 12: payment.PaymentService.RefundPayment:input_type -> payment.RefundPaymentRequest
	6,  // 13: payment.PaymentService.ProcessPayment:output_type -> payment.ProcessPaymentResponse
	8,  // 14: payment.PaymentService.GetPayment:output_type -> payment.GetPaymentResponse
	10, // 15: payment.PaymentService.RefundPayment:output_type -> payment.RefundPaymentResponse
