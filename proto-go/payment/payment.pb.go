...
type Money struct {
	...
	Amount        int64                  `protobuf:"varint,1,opt,name=amount,proto3" json:"amount,omitempty"`    // amount in minor units (e.g., cents)
...
const file_payment_payment_proto_rawDesc = "" +
	...
	"\x06amount\x18\x04 \x01(\v2\x0e.payment.MoneyR\x06amount\x12.\n" +
	...
	"\x06amount\x18\x03 \x01(\v2\x0e.payment.MoneyR\x06amount\x12.\n" +
	...
	"\apayment\x18\x01 \x01(\v2\x10.payment.PaymentR\apayment\"u\n" +
	"\x14RefundPaymentRequest\x12\x1d\n" +
	"\n" +
	"payment_id\x18\x01 \x01(\tR\tpaymentId\x12&\n" +
	"\x06amount\x18\x02 \x01(\v2\x0e.payment.MoneyR\x06amount\x12\x16\n" +
...
var file_payment_payment_proto_depIdxs = []int32{
	2,  // 0: payment.Payment.amount:type_name -> payment.Money
	0,  // 1: payment.Payment.status:type_name -> payment.PaymentStatus
	1,  // 2: payment.Payment.method:type_name -> payment.PaymentMethod
	11, // 3: payment.Payment.created_at:type_name -> google.protobuf.Timestamp
	11, // 4: payment.Payment.updated_at:type_name -> google.protobuf.Timestamp
	2,  // 5: payment.ProcessPaymentRequest.amount:type_name -> payment.Money
	1,  // 6: payment.ProcessPaymentRequest.method:type_name -> payment.PaymentMethod
	5,  // 7: payment.ProcessPaymentRequest.details:type_name -> payment.PaymentDetails
	3,  // 8: payment.ProcessPaymentResponse.payment:type_name -> payment.Payment
	3,  // 9: payment.GetPaymentResponse.payment:type_name -> payment.Payment
	2,  // 10: payment.RefundPaymentRequest.amount:type_name -> payment.Money
	3,  // 11: payment.RefundPaymentResponse.payment:type_name -> payment.Payment
	4,  // 12: payment.PaymentService.ProcessPayment:input_type -> payment.ProcessPaymentRequest
	7,  // 13: payment.PaymentService.GetPayment:input_type -> payment.GetPaymentRequest
	9,  // 14: payment.PaymentService.RefundPayment:input_type -> payment.RefundPaymentRequest
	6,  // 15: payment.PaymentService.ProcessPayment:output_type -> payment.ProcessPaymentResponse
	8,  // 16: payment.PaymentService.GetPayment:output_type -> payment.GetPaymentResponse
	10, // 17: payment.PaymentService.RefundPayment:output_type -> payment.RefundPaymentResponse
